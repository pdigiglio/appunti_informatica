...
C'erano,\marginpar{Computer e contabili} tuttavia i \emph{computer} che, in lingua inglese, erano i contabili.
...
\begin{wrapfloat}{figure}{i}{0pt}
	...
	\label{fig:tm}
\end{wrapfloat}
Partendo \marginpar{Macchina di Turing} da quanto detto finora, Turing immaginò la cosiddetta \emph{Macchina di Turing} (figura~\ref{fig:tm}).
