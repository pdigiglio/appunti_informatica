...
\]
Si riscontra, quindi, che l'algoritmo \algo{merge sort} è più efficiente dell'algoritmo \algo{bubble sort}.
\begin{table}
	\centering
	\caption[Costo dell'algoritmo \algo{bubble sort}]{Costo computazionale di un algoritmo \algo{bubble sort} ($n\in\mathbb{N}\sm\Set{0}$).}
	\label{tab:bubble}
	\begin{tabular}{>$c<$ >$c<$}
		\toprule
