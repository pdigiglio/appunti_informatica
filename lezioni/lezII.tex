...
Il\marginpar{Tipi} concetto di tipo non è una caratteristica di tutti i linguaggi di programmazione.
In linguaggio \lang{C} è \emph{necessario} specificare il tipo di una variabile ma lo stesso non vale, ad esempio, per linguaggi come il \lang{Python}.
